...
public class UserQuery {
    ...
    public static final String INSERT_USER_QUERY = "INSERT INTO Users (first_name, last_name, email, password,department) VALUES (:firstName, :lastName, :email, :password,department)";
